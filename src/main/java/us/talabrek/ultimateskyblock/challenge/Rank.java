        ...
        if (requires != null) {
            if (previousRank != null) {
                ...
                if (leeway > rankLeeway) {
                    missing.add(I18nUtil.tr("\u00a77Complete {0} more {1} \u00a77challenges", (leeway - rankLeeway), previousRank));
                }
            }
            ...
            if (missingChallenges != null) {
                missing.add(I18nUtil.tr("\u00a77Complete {0}", missingChallenges));
            }
            if (!missing.isEmpty()) {
            ...
            if (previousRank != null) {
                ...
                if (leeway > defaults.rankLeeway) {
                    missing.add(I18nUtil.tr("\u00a77Complete {0} more {1} \u00a77challenges", (leeway - defaults.rankLeeway), previousRank));
                }
            }
        }
        return missing;
